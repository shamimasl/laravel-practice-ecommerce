        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                    ...
                    <input type="hidden" value="{{ session('subtotal_from_cart') }}" name="final_sub_total">
                    <div class="col-md-4 order-md-2 mb-4">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            ...
                            <span class="text-muted">{{ session('total_from_cart') }} TK</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                            ...
                            <span class="text-muted">{{ session('discount_from_cart') }} TK</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span>Total (BDT)</span>
                            <strong>{{ session('subtotal_from_cart') }} TK</strong>
                        </li>
                        </ul>
                    </div>
